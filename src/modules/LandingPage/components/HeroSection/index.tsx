...
const HeroSection: React.FC = () => {
    return (
        <>
            <section className='w-full overflow-hidden text-white hidden lg:block'>
                <div className='heroImage min-h-screen'>
                    <div className='lg:w-9/12 h-full absolute top-[0%] lg:left-[15%] flex lg:flex-row flex-col-reverse'>
                        <motion.div initial={{ opacity: 0, y: 100 }}
                            ...
                            <motion.h2
                                ...
                                transition={{ duration: 1, ease: 'easeOut' }}
                                className='lg:text-7xl text-xl font'>Brew the Perfect Cup Every Time</motion.h2>
                        ...
                        <motion.div initial={{ opacity: 0, y: 100 }}
                            ...
                            <div
                                className='relative'>
                                <img className='w-32 lg:w-full' src="https://cdn.shopify.com/s/files/1/0726/1221/7115/files/ecom-no-replace-RUYPYkqNjZcoffee-m-layer.png?v=1723540466" alt="" />
                                <motion.div
                                    initial={{ opacity: 0, scale: 0.5 }}
                                    animate={{ opacity: 1, scale: 1 }}
                                    transition={{ duration: 1 }}
                                    className='absolute -top-10 right-0'>
                                    <img className='' src="https://cdn.shopify.com/s/files/1/0726/1221/7115/files/ecom-no-replace-mRuu436zTFlogo-br.png?v=1723540535" alt="" />
                                </motion.div>
                                <motion.div
                                    initial={{ opacity: 0, scale: 0.5 }}
                                    animate={{ opacity: 1, scale: 1 }}
