...
const OrderServices: React.FC<Props> = ({ iconSrc, serviceLabel, serviceDescription, buttonLabel }) => {
    return (
        <>
            <div className='lg:w-6/12 w-full shadow-lg bg-white rounded-xl p-4 flex flex-col gap-y-4'>
                ...
                <button className='flex bg-black mx-auto items-center lg:text-xl px-4 py-2 gap-x-3 rounded-full'>{buttonLabel}<FaArrowRightLong /></button>
            </div>
        </>
    );
};
